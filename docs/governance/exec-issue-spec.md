---
title: Executive review — issues, milestones & dashboard
permalink: /governance/exec-issue-spec/
---
...
**Milestones** ([view on GitHub](https://github.com/reasonreserve/portfolio/milestones)) — phase windows and due dates:

| Milestone | Window | GitHub due (phase end) | Issue |
|-----------|--------|--------------------------|--------|
| Phase I — M1–M6 | 2026-04-01 — 2026-09-30 | 2026-09-30 | [#1](https://github.com/reasonreserve/portfolio/issues/1) |
...
| Label | Use |
|-------|-----|
| `phase` | Phase epics `#1`–`#3` |
| `outcome` | Outcome epics `#4`–`#7` |
| `exec-review` | Items on the next leadership agenda (optional) |
